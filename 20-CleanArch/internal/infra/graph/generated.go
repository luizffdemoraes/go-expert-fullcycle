...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalOOrderInput2ᚖgithubᚗcomᚋluizffdemoraesᚋ20ᚑCleanArchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOOrder2ᚖgithubᚗcomᚋluizffdemoraesᚋ20ᚑCleanArchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋluizffdemoraesᚋ20ᚑCleanArchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOOrderInput2ᚖgithubᚗcomᚋluizffdemoraesᚋ20ᚑCleanArchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v any) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
